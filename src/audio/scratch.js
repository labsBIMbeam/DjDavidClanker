...
/**
 * Queue depth, and therefore how long after a position is written the matching
 * audio is actually heard. Anything scheduling against the record's motion —
 * autoscratch's fader, for one — has to add this or it lands early.
 */
